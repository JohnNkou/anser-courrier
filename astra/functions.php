...
add_action('wp_enqueue_scripts',function(){
    ...
    if($has_view_short || $has_flow_short){
        flogs("BANANA");
        wp_enqueue_style('custom/global', '/css/global.css',[],'1.8');
        wp_enqueue_style('custom/modal','/css/modal.css',[],'1.3');
        ...
        if($has_flow_short){
            flogs("MUSSHROOM");
            wp_enqueue_style("custom_flow","/css/flow.css",[],'1.3');
        }
    }
});
...
add_shortcode("anser_gravityflow",function(...$atts){
    if(!class_exists("Anser_GravityFlow")){
        require_once ABSPATH ."anser-php/anser_gravityflow.php";
        require_once ABSPATH ."anser-php/anser_gravityflow_inbox.php";
    }
