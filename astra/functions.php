...
add_action('gform_after_submission','handle_gravity_form_submission',10,2);
add_action( 'gform_post_process', 'handle_gravity_form_submission', 10, 2 );
add_action('gform_post_multifile_upload','handle_gravity_form_submission',10,2);
