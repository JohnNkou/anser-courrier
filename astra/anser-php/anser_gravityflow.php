	...
	class Anser_GravityFlow extends GFFeedAddOn {
		...
		*/
		...
		public function pre_init() {
			require_once( ABSPATH . '/wp-content/plugins/gravityflow/includes/pages/class-inbox.php' );
			require_once( ABSPATH . '/wp-content/plugins/gravityflow/includes/pages/class-reports.php' );
