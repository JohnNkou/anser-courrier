		...
		add_filter('option_active_plugins', function($plugins) use(&$displayed){
			if(isset($_REQUEST['action'])){
		        ...
		        elseif (in_array($_REQUEST['action'], [
		        	...
		        	$authorized_plugins = ['gravityview.php','gravityforms.php','gravityview-diy','gravityview-entry-revisions','gravityview-advanced-filter','gravityview-multiple-forms'];
		        }
