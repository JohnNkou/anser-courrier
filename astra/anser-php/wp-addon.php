			...
			if(isset($_REQUEST['action'])){
				if(true/*$_SERVER['REQUEST_METHOD'] == 'GET'*/){
			        ...
			        if(in_array($_REQUEST['action'], [
			        	...
			        	$authorized_plugins = ['gravityform','gravityflow.php','gravityview.php','gp-','gravity-notifications.php','gravityview-importer','gravityview-entry-revisions','gravityview-featured-entries'];
			        }
