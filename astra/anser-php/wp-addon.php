		...
		add_filter('option_active_plugins', function($plugins) use(&$displayed){
			if(isset($_REQUEST['action'])){
		        ...
		        if(in_array($_REQUEST['action'], [
		        	...
		        	$authorized_plugins = ['gravityview','gravityflow','gravityform','gravity-forms','gf-', 'gravityforms.php','gravityflow.php','gravityview.php','gp-', 'gravityformswebhooks','gravityformsadvancedpostcreation'];
