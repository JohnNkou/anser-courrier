...
var require_anser_utily = __commonJS((exports) => {
  ...
  exports.page_handler = function page_handler(navigationHandler) {
    ...
    this.goTo = (newPage) => {
      toggle_disable(true);
      this.load_data(newPage * 10).then((json_response) => {
        this.page = newPage;
...
// js/anser_gravity.js
var require_anser_gravity = __commonJS((exports) => {
...
export default require_anser_gravity();
