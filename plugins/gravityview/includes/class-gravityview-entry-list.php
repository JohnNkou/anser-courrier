...
class GravityView_Entry_List {
	...
	function __construct( $entries = array(), $post_id = 0, $form = array(), $link_format = '', $after_link = '', $context = '', $template_context = null, $view_id = 0 ) {
		...
		$this->empty_message    = function_exists( 'gv_no_results' ) ? gv_no_results( $template_context ) : __( 'No entries match your request.', 'gk-gravityview' ); error_log("BUILDING THE LIST OF ENTRIES");
	}
